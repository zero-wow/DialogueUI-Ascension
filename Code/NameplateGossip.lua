...
-- This experimental module requires a genuinely backported nameplate API.
-- Do not manufacture C_NamePlate on stock Wrath: its mere presence changes
-- capability detection in unrelated addons.
...
function NameplateGossip:Init()
    ...
    self.Background:SetTexture("Interface/AddOns/DialogueUI-Ascension/Art/Theme_Shared/NameplateDialogShadow.tga");
