...
function Clipboard:Init()
    ...
    bg:SetTexture("Interface/AddOns/DialogueUI-Ascension/Art/Theme_Shared/ClipboardBackground.tga");
...
do  --Copy Text Button
    ...
    local function CreateCopyTextButton(parent, onClickFunc, themeID)
        ...
        b.Icon:SetTexture("Interface/AddOns/DialogueUI-Ascension/Art/Theme_Shared/CopyTextButton.tga");
