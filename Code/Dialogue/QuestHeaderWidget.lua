...
local BASE_TEXTURE = "Interface/AddOns/DialogueUI-Ascension/Art/Theme_Shared/QuestWidgetButton.tga";
...
do  --ButtonMixin
    ...
    function ButtonMixin:SetAccountQuest()
        self.type = "Account";
        self.uiOrder = 4;
        self:SetIcon("Interface/AddOns/DialogueUI-Ascension/Art/Icons/Warband.tga");
