...
function FriendshipBar:Init()
    ...
    FillMask:SetTexture("Interface/AddOns/DialogueUI-Ascension/Art/Theme_Shared/Mask-HeartFill", "CLAMPTOBLACKADDITIVE", "CLAMPTOBLACKADDITIVE");
...
function FriendshipBar:LoadTheme()
    ...
    local barFile = addon.ThemeUtil:GetTextureFile("FriendshipBar.tga");
