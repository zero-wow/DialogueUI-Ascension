...
do  --Actions Types
    function ItemButtonMixin:SetUsableItem(item, allowPressKeyToUse)
        ...
        self:RegisterEvent(addon.IS_LEGACY_ASCENSION and "BAG_UPDATE" or "BAG_UPDATE_DELAYED");
    ...
    function ItemButtonMixin:SetEditMode()
        ...
        self:SetIcon(addon.IS_LEGACY_ASCENSION and "Interface\\Icons\\INV_Misc_QuestionMark" or 134400);
...
do  --Determine if the item is learned/used
    ...
    function ItemButtonMixin:IsKnownPet()
        if self.itemID and C_PetJournal and C_PetJournal.GetPetInfoByItemID and C_PetJournal.FindPetIDByName then
    ...
    function ItemButtonMixin:IsKnownToy()
        if self.itemID and PlayerHasToy then
...
local function CreateItemActionButton(parent, additionalMixin)
    ...
    f.Cooldown.noCooldownCount = true; -- OmniCC convention; replaces Retail XML KeyValues.
    local texture = "Interface/AddOns/DialogueUI-Ascension/Art/Theme_Shared/QuestFlyoutButton.tga";
    ...
    f:SetIcon(addon.IS_LEGACY_ASCENSION and "Interface\\Icons\\INV_Misc_QuestionMark" or 132940);
