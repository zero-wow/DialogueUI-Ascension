...
do  --Auto Close Button
    ...
    function WidgetManager:CreateAutoCloseButton(parent)
        ...
        local function CreateSwipe(isRight)
            ...
            mask:SetTexture("Interface/AddOns/DialogueUI-Ascension/Art/BasicShapes/Mask-RightWhite", "CLAMPTOBLACKADDITIVE", "CLAMPTOBLACKADDITIVE");
        ...
        local file = "Interface/AddOns/DialogueUI-Ascension/Art/Theme_Shared/WidgetCloseButton.tga";
        bt:SetTexture(file);
...
do  --Change Main Anchor Position
    ...
    function AnchorPosition:Init()
        ...
        local file = "Interface/AddOns/DialogueUI-Ascension/Art/Theme_Shared/QuestPopup.tga";
        ...
        if state then
            if not self.linkPool then
                ...
                local function OnCreate()
                    ...
                    f.Icon = Icon;
                    Icon:SetTexture("Interface/AddOns/DialogueUI-Ascension/Art/Theme_Shared/QuestPopup.tga");
