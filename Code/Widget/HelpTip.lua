...
do  --Help UI
    ...
    function HelpFrameMixin:Init()
        ...
        -- parentArray is not available in the legacy XML parser.
        self.ArrowFrame.Arrows = {self.ArrowFrame.Arrow1};

        self:SetScript("OnHide", self.OnHide);
        self:SetScript("OnMouseUp", self.OnMouseUp);

        local file = "Interface/AddOns/DialogueUI-Ascension/Art/Theme_Shared/HelpTip.tga";
    ...
    function HelpFrameMixin:SetArrowPointingDirection(direction)
        ...
        if direction == "RIGHT" then
            ...
            self.ArrowAnimation = self.ArrowFrame.Arrow1.AnimPointRight;
        end
        ...
        self.ArrowFrame.Arrow1:StopAnimating();
    end
