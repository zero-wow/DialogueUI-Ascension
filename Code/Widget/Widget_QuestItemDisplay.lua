...
function QuestItemDisplay:Init()
    ...
    local function CreateQueueMarker()
        ...
        texture:SetTexture(ThemeUtil:GetTextureFile("QuestItemDisplay-UI.tga"));
...
function QuestItemDisplay:LoadTheme()
    ...
    local file = ThemeUtil:GetTextureFile("QuestItemDisplay-UI.tga");
...
function QuestItemDisplay:SetStartQuestItem(itemID, startQuestID, isOnQuest)
    ...
    local icon = "Interface/AddOns/DialogueUI-Ascension/Art/Icons/QuestItem-NotOnQuest.tga";
...
function QuestItemDisplay:ToggleEditMode()
    ...
    self.ItemIcon:SetTexture(addon.IS_LEGACY_ASCENSION and "Interface\\Icons\\INV_Misc_QuestionMark" or 134400);   --QuestionMark
