...
local RankIcons = {
    [1] = "Interface/AddOns/DialogueUI-Ascension/Art/Icons/Racing-Gold.tga",
    [2] = "Interface/AddOns/DialogueUI-Ascension/Art/Icons/Racing-Silver.tga",
    [3] = "Interface/AddOns/DialogueUI-Ascension/Art/Icons/Racing-Bronze.tga",
    [4] = "Interface/AddOns/DialogueUI-Ascension/Art/Icons/Racing-None.tga",
};
