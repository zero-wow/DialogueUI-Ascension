...
local DEFAULT_FONT_FILE = {
    roman = "Interface/AddOns/DialogueUI-Ascension/Fonts/frizqt__.ttf",       --Friz Quadrata
    korean = "Fonts/2002.TTF",
    simplifiedchinese = "Fonts/ARKai_T.ttf",
    traditionalchinese = "Fonts/blei00d.TTF",
    russian = "Interface/AddOns/DialogueUI-Ascension/Fonts/frizqt___cyr.ttf",
};

local NUMBER_FONT_FILE = { -- Number12Font
    roman = "Interface/AddOns/DialogueUI-Ascension/Fonts/ARIALN.ttf",
    korean = "Fonts/2002.TTF",
    simplifiedchinese = "Fonts/ARHei.ttf",
    traditionalchinese = "Fonts/bHEI01B.TTF",
    russian = "Interface/AddOns/DialogueUI-Ascension/Fonts/ARIALN.ttf",
};

local DEFAULT_BOOK_TITLE_FONT_FILE = {
    roman = "Interface/AddOns/DialogueUI-Ascension/Fonts/TrajanPro3SemiBold.ttf",
};
