...
local TEXTURE_INFO = {
    ...
    ["HotkeyBackground.tga"] = {32, 32, 8, 8, 8, 8},
};
...
do  -- Texture Slicing (Temp Fix for https://github.com/Stanzilla/WoWUIBugs/issues/547)
    ...
    function PseudoSliceTextureMixin:OnLoad()
        self.Slices = {
            self.Slice1, self.Slice2, self.Slice3,
            self.Slice4, self.Slice5, self.Slice6,
            self.Slice7, self.Slice8, self.Slice9,
        };
        self.drawLayer = self.drawLayer or "BACKGROUND";
        self.textureSubLevel = self.textureSubLevel or 0;
