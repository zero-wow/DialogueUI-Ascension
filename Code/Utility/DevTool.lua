...
do  --Camera Calibrator
    ...
    local function Calibrator_Init()
        ...
        local GetCameraZoom = GetCameraZoom or function() return 0 end;
        local GetCVar = C_CVar.GetCVar;

        local function FormatReading(label, value)
            return "|cffffd100"..label..":|r "..string.format("%.2f", tonumber(value) or 0)
        end
        ...
        local function CreateArrowButton(f, isLeft)
            ...
            Arrow:SetSize(18, 18);
            Arrow:SetTexture("Interface/AddOns/DialogueUI-Ascension/Art/Theme_Dark/Settings-ArrowOption.tga");
            if isLeft then
