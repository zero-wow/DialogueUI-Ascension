...
L["Frame Size Desc"] = "Set the size of the dialogue UI. Ctrl + Mouse Wheel over the dialogue frame selects Custom and fine-tunes its scale.\n\nDefault: Medium";
L["Size Extra Small"] = "Extra Small";
L["Size Small"] = "Small";
L["Size Medium"] = "Medium";
L["Size Large"] = "Large";
L["Size Extra Large"] = "X-Large";
L["Size Custom"] = "Custom";
L["Custom Font Size"] = "Custom Font Size";
L["Custom Font Size Desc"] = "Choose the exact base font size used when Font Size is set to Custom.";
L["Font Size"] = "Font Size";
L["Font Size Desc"] = "Set the font size for the UI. Choose Custom to select an exact size from 10 to 24 pt.\n\nDefault: 12";
L["Font"] = "Font";
...
L["Lock Frames Desc"] = "Prevent the dialogue and settings frames from being dragged. Hold Shift while dragging to move a locked frame temporarily.";
L["Reset Frame Positions"] = "Reset Frame Positions";
L["Reset Frame Positions Desc"] = "Return the dialogue and settings frames to their automatic positions.";
L["Hide UI"] = "Hide UI";
